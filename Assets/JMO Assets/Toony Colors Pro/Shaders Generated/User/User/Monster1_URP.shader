...
Shader "Toony Colors Pro 2/User/Monster1_URP"
{
	Properties
	{
		[TCP2HeaderHelp(Base)]
	...
	SubShader
	{
		...
		Pass
		{
			...
			struct Varyings
			{
				...
				float4 pack3 : TEXCOORD6; /* pack3.xy = texcoord0  pack3.zw = matcap */
				UNITY_VERTEX_INPUT_INSTANCE_ID
				UNITY_VERTEX_OUTPUT_STEREO
			};
			...
			Varyings Vertex(Attributes input)
			{
				...
				output.pack3.zw = worldNorm.xy * 0.5 + 0.5;
				#endif
			...
			half4 Fragment(Varyings input) : SV_Target
			{
				...
				float3 __emission = ( _Emission.rgb * tex2D(_EmissionTexture, input.pack3.xy * _EmissionTexture_ST.xy + _EmissionTexture_ST.zw).rgb );
				...
				//MatCap
				#if defined(TCP2_MATCAP)
				fixed3 matcap = tex2D(_MatCapTex, input.pack3.zw).rgb * __matcapColor;
				albedo *= matcap;
				#endif
...
/* TCP_DATA u config(unity:"2020.3.0f1c1";ver:"2.7.1";tmplt:"SG2_Template_URP";features:list["UNITY_5_4","UNITY_5_5","UNITY_5_6","UNITY_2017_1","UNITY_2018_1","UNITY_2018_2","UNITY_2018_3","UNITY_2019_1","UNITY_2019_2","UNITY_2019_3","UNITY_2020_1","SILHOUETTE_URP_FEATURE","OUTLINE","OUTLINE_URP_FEATURE","SKETCH_AMBIENT","DISSOLVE_CLIP","DISSOLVE_GRADIENT","SKETCH","SPECULAR","SPEC_LEGACY","SPECULAR_RAMP","EMISSION","RAMP_MAIN_OTHER","RAMP_SEPARATED","SHADOW_COLOR_MAIN_DIR","ALBEDO_HSV","ALBEDO_HSV_MASK","BUMP","MATCAP","MATCAP_MULT","MATCAP_SHADER_FEATURE","SHADER_BLENDING","TEMPLATE_LWRP","MULTIPLICATIVE_BLENDING"];flags:list[];flags_extra:dict[];keywords:dict[RENDER_TYPE="Opaque",RampTextureDrawer="[TCP2Gradient]",RampTextureLabel="Ramp Texture",SHADER_TARGET="3.0"];shaderProperties:list[,,,,,,,,,,,,,,,sp(name:"Emission";imps:list[imp_mp_color(def:RGBA(0, 0, 0, 1);hdr:True;cc:3;chan:"RGB";prop:"_Emission";md:"";custom:False;refs:"";guid:"8d48afba-34cf-4d92-8943-298295296f27";op:Multiply;lbl:"Emission Color";gpu_inst:False;locked:False;impl_index:0),imp_mp_texture(uto:True;tov:"";tov_lbl:"";gto:False;sbt:False;scr:False;scv:"";scv_lbl:"";gsc:False;roff:False;goff:False;sin_anm:False;sin_anmv:"";sin_anmv_lbl:"";gsin:False;notile:False;triplanar_local:False;def:"white";locked_uv:False;uv:0;cc:3;chan:"RGB";mip:-1;mipprop:False;ssuv_vert:False;ssuv_obj:False;uv_type:Texcoord;uv_chan:"XZ";uv_shaderproperty:__NULL__;prop:"_EmissionTexture";md:"";custom:False;refs:"";guid:"7d34f7fa-ce2d-419f-9e67-75ec813f2cb8";op:Multiply;lbl:"Emission Texture";gpu_inst:False;locked:False;impl_index:-1)];layers:list[];unlocked:list[];clones:dict[];isClone:False),,,,,,,,,,,,,,,,,,,,,sp(name:"Blend Operation";imps:list[imp_enum(value_type:0;value:1;enum_type:"ToonyColorsPro.ShaderGenerator.BlendOperation";guid:"b5e98a58-dc80-4dfd-8922-43352148b282";op:Multiply;lbl:"Blend Operation";gpu_inst:False;locked:False;impl_index:0)];layers:list[];unlocked:list[];clones:dict[];isClone:False)];customTextures:list[];codeInjection:codeInjection(injectedFiles:list[];mark:False);matLayers:list[]) */
/* TCP_HASH ca6c9a0e18df8690a648f06cfb7fd7af */
